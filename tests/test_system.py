...
class SystemTester:
    ...
    def _load_test_queries(
        self, num_queries: int = 10, seed: int = 42
    ...
    def test_configuration(self) -> bool:
        ...
        try:
            ...
            self.log_test(
                "Configuration", True, "Configuration loaded and validated successfully"
            )
            return True

        except Exception as e:
            self.log_test("Configuration", False, f"Configuration error: {str(e)}")
            return False
    ...
    async def test_agent_connectivity(self) -> bool:
        ...
        for url in agent_urls:
            try:
                ...
                self.log_test(
                    f"Agent Connectivity ({url})", False, f"Connection error: {str(e)}"
                )
                all_connected = False
    ...
    async def test_agent_discovery(self) -> bool:
        ...
        try:
            ...
            self.log_test("Agent Discovery", False, f"Discovery error: {str(e)}")
            return False
    ...
    async def test_video_search_agent(self) -> bool:
        ...
        try:
            ...
            if "error" in response:
                self.log_test(
                    "Video Search Agent", False, f"Search failed: {response['error']}"
                )
                return False
            ...
            self.log_test("Video Search Agent", False, f"Test error: {str(e)}")
            return False
    ...
    def test_data_directories(self) -> bool:
        ...
        try:
            ...
            self.log_test("Data Directories", True, "All required directories exist")
            return True

        except Exception as e:
            self.log_test("Data Directories", False, f"Test error: {str(e)}")
            return False
    ...
    def test_model_imports(self) -> bool:
        ...
        try:
            ...
            self.log_test(
                "Model Imports", True, "All required libraries imported successfully"
            )
            return True

        except Exception as e:
            self.log_test("Model Imports", False, f"Test error: {str(e)}")
            return False
    ...
    def test_llm_connectivity(self) -> bool:
        ...
        try:
            ...
            if not models:
                self.log_test(
                    "Local LLM Models", False, "No models installed in local LLM server"
                )
                return False
            ...
            self.log_test(
                "Local LLM Connectivity", False, f"Local LLM test error: {str(e)}"
            )
            return False
    ...
    async def test_end_to_end_system(self) -> bool:
        ...
        try:
            ...
            self.log_test(
                "End-to-End System", False, f"End-to-end test error: {str(e)}"
            )
            return False

    async def run_tests(
        self, test_selection: Optional[List[str]] = None
    ) -> Dict[str, Any]:
        ...
        if test_selection:
            test_functions = [
                (name, func)
                for name, func in all_test_functions
                if name.lower().replace(" ", "_")
                in [t.lower().replace(" ", "_") for t in test_selection]
            ]
...
async def main():
    ...
    tester.test_queries = tester._load_test_queries(
