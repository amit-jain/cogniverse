...
from src.app.routing.adaptive_threshold_learner import AdaptiveThresholdLearner, ThresholdParameter
...
class TestDSPySystemIntegration:
        ...
        for query in test_queries:
            try:
                ...
                if entities or relationships:
                    ...
                    assert len(relationships) >= 0  # Could be empty if no relationships found
    ...
    def test_dspy_components_integration(self):
        ...
        try:
            ...
            assert hasattr(components['extractor'], 'extract_comprehensive_relationships')
