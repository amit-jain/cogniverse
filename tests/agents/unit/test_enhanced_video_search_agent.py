...
from src.app.agents.enhanced_video_search_agent import (
    EnhancedVideoSearchAgent, VideoProcessor, VideoPart, ImagePart, 
    EnhancedA2AMessage, EnhancedTask
)
...
class TestVideoProcessor:
    ...
    def test_process_video_file_without_video_support(self, mock_query_encoder):
        ...
        with pytest.raises(NotImplementedError, match="Query encoder does not support video encoding"):
    ...
    def test_process_image_file_without_image_support(self, mock_query_encoder):
        ...
        with pytest.raises(NotImplementedError, match="Query encoder does not support image encoding"):
...
class TestEnhancedVideoSearchAgent:
    ...
    def test_enhanced_agent_initialization(self, mock_get_config, mock_vespa_class, mock_encoder_factory, 
                                         mock_config, mock_vespa_client, mock_query_encoder):
    ...
    @patch('src.app.agents.enhanced_video_search_agent.VespaVideoSearchClient')
    @patch('src.app.agents.enhanced_video_search_agent.get_config')
    def test_search_by_text(self, mock_get_config, mock_vespa_class, mock_encoder_factory,
                           mock_config, mock_vespa_client, mock_query_encoder):
    ...
    @patch('src.app.agents.enhanced_video_search_agent.VespaVideoSearchClient') 
    @patch('src.app.agents.enhanced_video_search_agent.get_config')
    def test_search_by_video(self, mock_get_config, mock_vespa_class, mock_encoder_factory,
                            mock_config, mock_vespa_client, mock_query_encoder):
        ...
        agent.video_processor.process_video_file = Mock(return_value=np.random.rand(128))
        ...
        assert len(results) == 2
        assert results[0]["video_id"] == "video1"
        agent.video_processor.process_video_file.assert_called_once_with(video_data, "test.mp4")
        mock_vespa_client.search.assert_called_once()
    
    @patch('src.app.agents.enhanced_video_search_agent.QueryEncoderFactory')
    @patch('src.app.agents.enhanced_video_search_agent.VespaVideoSearchClient')
    @patch('src.app.agents.enhanced_video_search_agent.get_config')
    def test_search_by_image(self, mock_get_config, mock_vespa_class, mock_encoder_factory,
                            mock_config, mock_vespa_client, mock_query_encoder):
        ...
        # Mock video processor
        agent.video_processor.process_image_file = Mock(return_value=np.random.rand(128))
        ...
        assert len(results) == 2
        assert results[0]["video_id"] == "video1"
        agent.video_processor.process_image_file.assert_called_once_with(image_data, "test.jpg")
        mock_vespa_client.search.assert_called_once()
    
    @patch('src.app.agents.enhanced_video_search_agent.QueryEncoderFactory')
    @patch('src.app.agents.enhanced_video_search_agent.VespaVideoSearchClient')
    @patch('src.app.agents.enhanced_video_search_agent.get_config')
    def test_process_enhanced_task_with_text(self, mock_get_config, mock_vespa_class, mock_encoder_factory,
                                           mock_config, mock_vespa_client, mock_query_encoder):
        ...
        message = EnhancedA2AMessage(
            role="user",
            parts=[DataPart(data={"query": "find dogs", "top_k": 5})]
        )
    ...
    @patch('src.app.agents.enhanced_video_search_agent.VespaVideoSearchClient')
    @patch('src.app.agents.enhanced_video_search_agent.get_config')
    def test_process_enhanced_task_with_video(self, mock_get_config, mock_vespa_class, mock_encoder_factory,
                                            mock_config, mock_vespa_client, mock_query_encoder):
    ...
    @patch('src.app.agents.enhanced_video_search_agent.VespaVideoSearchClient')
    @patch('src.app.agents.enhanced_video_search_agent.get_config')
    def test_process_enhanced_task_with_image(self, mock_get_config, mock_vespa_class, mock_encoder_factory,
                                            mock_config, mock_vespa_client, mock_query_encoder):
    ...
    @patch('src.app.agents.enhanced_video_search_agent.VespaVideoSearchClient')
    @patch('src.app.agents.enhanced_video_search_agent.get_config')
    def test_process_enhanced_task_with_mixed_parts(self, mock_get_config, mock_vespa_class, mock_encoder_factory,
                                                  mock_config, mock_vespa_client, mock_query_encoder):
    ...
    @patch('src.app.agents.enhanced_video_search_agent.VespaVideoSearchClient')
    @patch('src.app.agents.enhanced_video_search_agent.get_config')
    def test_process_enhanced_task_empty_messages(self, mock_get_config, mock_vespa_class, mock_encoder_factory,
                                                mock_config, mock_vespa_client, mock_query_encoder):
    ...
    @patch('src.app.agents.enhanced_video_search_agent.VespaVideoSearchClient')
    @patch('src.app.agents.enhanced_video_search_agent.get_config')
    def test_process_enhanced_task_no_valid_parts(self, mock_get_config, mock_vespa_class, mock_encoder_factory,
                                                mock_config, mock_vespa_client, mock_query_encoder):
        ...
        message = EnhancedA2AMessage(
            role="user",
            parts=[DataPart(data={"no_query": "invalid"})]
        )
        task = EnhancedTask(id="test_task", messages=[message])
...
class TestEnhancedVideoSearchAgentEdgeCases:
    ...
    @patch('src.app.agents.enhanced_video_search_agent.VespaVideoSearchClient')
    @patch('src.app.agents.enhanced_video_search_agent.get_config')
    def test_vespa_client_initialization_failure(self, mock_get_config, mock_vespa_class):
    ...
    @patch('src.app.agents.enhanced_video_search_agent.VespaVideoSearchClient')
    @patch('src.app.agents.enhanced_video_search_agent.get_config')
    def test_query_encoder_initialization_failure(self, mock_get_config, mock_vespa_class, mock_encoder_factory):
        ...
        mock_encoder_factory.create_encoder.side_effect = Exception("Encoder creation failed")
    ...
    @patch('src.app.agents.enhanced_video_search_agent.VespaVideoSearchClient')
    @patch('src.app.agents.enhanced_video_search_agent.get_config')
    def test_search_failure_handling(self, mock_get_config, mock_vespa_class, mock_encoder_factory):
