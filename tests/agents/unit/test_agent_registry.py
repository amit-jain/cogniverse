...
from src.app.agents.agent_registry import AgentRegistry, AgentEndpoint
...
class TestAgentRegistry:
    ...
    def test_get_agents_for_workflow(self, mock_get_config):
        ...
        video_agent = AgentEndpoint("video_agent", "http://localhost:8001", ["video_search"])
        text_agent = AgentEndpoint("text_agent", "http://localhost:8002", ["text_search"])
        summary_agent = AgentEndpoint("summary_agent", "http://localhost:8003", ["summarization"])
        analysis_agent = AgentEndpoint("analysis_agent", "http://localhost:8004", ["detailed_analysis"])
