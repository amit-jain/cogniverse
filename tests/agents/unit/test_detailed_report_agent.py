...
class TestVLMInterface:
    ...
    @pytest.mark.ci_fast
    def test_vlm_interface_initialization_success(self, mock_dspy_settings, mock_get_config):
    ...
    def test_vlm_interface_initialization_missing_config(self, mock_get_config):
        ...
        mock_get_config.return_value = {"llm": {"model_name": "test"}}  # Missing base_url
    ...
    @pytest.mark.asyncio
    async def test_analyze_visual_content_detailed(self, mock_predict, mock_dspy_settings, mock_get_config):
...
class TestDetailedReportAgent:
    ...
    @pytest.mark.ci_fast
    def test_detailed_report_agent_initialization(self, mock_vlm_class, mock_get_config):
    ...
    async def test_process_a2a_task_success(self, mock_vlm_class, mock_get_config):
        ...
        agent.generate_report = AsyncMock(return_value=ReportResult(
...
class TestDetailedReportAgentCoreFunctionality:
    ...
    def agent_with_mocks(self):
        ...
        with patch("src.app.agents.detailed_report_agent.get_config") as mock_config, \
             patch("src.app.agents.detailed_report_agent.VLMInterface") as mock_vlm_class, \
            ...
            mock_vlm = Mock()
            mock_vlm.analyze_visual_content_detailed = AsyncMock(return_value={
    ...
    @pytest.mark.ci_fast
    @pytest.mark.asyncio
    async def test_thinking_phase_functionality(self, agent_with_mocks, sample_report_request):
    ...
    @pytest.mark.ci_fast  
    @pytest.mark.asyncio
    async def test_visual_analysis_functionality(self, agent_with_mocks, sample_report_request):
        """Test visual analysis performs actual VLM calls"""
        agent = agent_with_mocks
        
        # Create proper thinking_phase with visual_assessment
        thinking_phase = ThinkingPhase(
            content_analysis={"total_results": 3, "content_types": {"video": 2, "image": 1}},
            visual_assessment={"has_visual_content": True, "visual_elements": {"images": 1}},
        ...
        image_results = [r for r in sample_report_request.search_results if r.get("content_type") == "image"]
        ...
        if image_results:
            ...
            visual_analysis = await agent._perform_visual_analysis(visual_request, thinking_phase)
    ...
    @pytest.mark.ci_fast
    @pytest.mark.asyncio
    async def test_generate_report_full_workflow(self, agent_with_mocks, sample_report_request):
        ...
        with patch('dspy.ChainOfThought') as mock_cot:
            ...
            mock_prediction.content_analysis = {"total_results": 3, "content_types": ["video", "image"]}
    ...
    @pytest.mark.ci_fast
    @pytest.mark.asyncio
    async def test_generate_executive_summary_logic(self, agent_with_mocks, sample_report_request):
        ...
        assert "3" in summary or "three" in summary.lower()  # Should mention result count

    @pytest.mark.ci_fast
    def test_generate_detailed_findings_logic(self, agent_with_mocks, sample_report_request):
        ...
        thinking_phase = ThinkingPhase(
            ...
            visual_assessment={"has_visual_content": True, "quality_score": 0.8, "visual_coverage": 7, "visual_elements": {"images": 2, "videos": 1}},
            technical_findings=["HD quality"],
            patterns_identified=["educational"],
            gaps_and_limitations=[],
            reasoning="test"
    ...
    @pytest.mark.ci_fast
    def test_generate_recommendations_logic(self, agent_with_mocks, sample_report_request):
        ...
        thinking_phase = ThinkingPhase(
            ...
            visual_assessment={"has_visual_content": True, "has_thumbnails": True, "visual_coverage": 8},
    ...
    @pytest.mark.ci_fast
    def test_analyze_content_structure_functionality(self, agent_with_mocks, sample_search_results):
