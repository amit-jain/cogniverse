...
def mock_config():
    ...
    return {"openai_api_key": "test_key", "anthropic_api_key": None}
...
class TestDetailedReportAgent:
    ...
    @patch("src.app.agents.detailed_report_agent.get_config")
    def test_assess_visual_content(
        self, mock_get_config, mock_config, sample_search_results
    ):
    ...
    @patch("src.app.agents.detailed_report_agent.get_config")
    def test_identify_technical_findings(
        self, mock_get_config, mock_config, sample_search_results
    ):
    ...
    @patch("src.app.agents.detailed_report_agent.get_config")
    def test_identify_gaps_and_limitations(
        self, mock_get_config, mock_config, sample_search_results
    ):
    ...
    async def test_thinking_phase(
        self, mock_get_config, mock_config, sample_report_request
    ):
    ...
    @patch("src.app.agents.detailed_report_agent.get_config")
    @pytest.mark.asyncio
    async def test_perform_visual_analysis_disabled(
        self, mock_get_config, mock_config, sample_report_request
    ):
        ...
        result = await agent._perform_visual_analysis(
    ...
    @patch("src.app.agents.detailed_report_agent.get_config")
    @pytest.mark.asyncio
    async def test_perform_visual_analysis_no_content(
        self, mock_get_config, mock_config, sample_report_request
    ):
    ...
    @patch("src.app.agents.detailed_report_agent.get_config")
    @pytest.mark.asyncio
    async def test_perform_visual_analysis_with_content(
        self, mock_get_config, mock_config, sample_report_request
    ):
    ...
    @patch("src.app.agents.detailed_report_agent.get_config")
    @pytest.mark.asyncio
    async def test_generate_executive_summary_no_results(
        self, mock_get_config, mock_config, sample_report_request
    ):
    ...
    @patch("src.app.agents.detailed_report_agent.get_config")
    def test_generate_detailed_findings(
        self, mock_get_config, mock_config, sample_report_request
    ):
    ...
    def test_generate_technical_details(
        ...
        details = agent._generate_technical_details(
            sample_report_request, thinking_phase
        )
    ...
    @patch("src.app.agents.detailed_report_agent.get_config")
    def test_generate_technical_details_disabled(
        self, mock_get_config, mock_config, sample_report_request
    ):
    ...
    @patch("src.app.agents.detailed_report_agent.get_config")
    def test_generate_recommendations_disabled(
        self, mock_get_config, mock_config, sample_report_request
    ):
    ...
    @patch("src.app.agents.detailed_report_agent.get_config")
    def test_calculate_confidence_assessment(
        self, mock_get_config, mock_config, sample_report_request
    ):
        ...
        thinking_phase = ThinkingPhase(
            content_analysis={"total_results": 10, "avg_relevance": 0.8},
            visual_assessment={"has_visual_content": True, "visual_coverage": 5},
        ...
        confidence = agent._calculate_confidence_assessment(
            sample_report_request, thinking_phase
        )
...
class TestDetailedReportAgentEdgeCases:
    ...
    async def test_generate_report_empty_results(self, mock_get_config, mock_config):
        ...
        request = ReportRequest(
            query="test query", search_results=[], report_type="comprehensive"
        )
    ...
    @patch("src.app.agents.detailed_report_agent.get_config")
    @pytest.mark.asyncio
    async def test_visual_analysis_failure(
        self, mock_get_config, mock_config, sample_report_request
    ):
...
class TestDataClasses:
    ...
    def test_report_request_defaults(self):
        ...
        request = ReportRequest(query="test", search_results=[])
