...
from src.app.agents.summarizer_agent import (
    SummarizerAgent, VLMInterface, SummaryRequest, ThinkingPhase, SummaryResult
)
...
class TestSummarizerAgent:
    ...
    @patch('src.app.agents.summarizer_agent.get_config')
    def test_categorize_content(self, mock_get_config, mock_config, sample_search_results):
    ...
    @patch('src.app.agents.summarizer_agent.get_config')
    def test_calculate_relevance_scores(self, mock_get_config, mock_config, sample_summary_request):
    ...
    @patch('src.app.agents.summarizer_agent.get_config')
    def test_identify_visual_elements(self, mock_get_config, mock_config, sample_search_results):
    ...
    @patch('src.app.agents.summarizer_agent.get_config')
    def test_generate_reasoning(self, mock_get_config, mock_config, sample_summary_request):
    ...
    @patch('src.app.agents.summarizer_agent.get_config')
    @pytest.mark.asyncio
    async def test_thinking_phase(self, mock_get_config, mock_config, sample_summary_request):
    ...
    @patch('src.app.agents.summarizer_agent.get_config')
    def test_generate_brief_summary(self, mock_get_config, mock_config, sample_summary_request, sample_search_results):
    ...
    @patch('src.app.agents.summarizer_agent.get_config')
    def test_generate_bullet_summary(self, mock_get_config, mock_config, sample_summary_request, sample_search_results):
    ...
    @patch('src.app.agents.summarizer_agent.get_config')
    def test_generate_comprehensive_summary(self, mock_get_config, mock_config, sample_summary_request, sample_search_results):
        ...
        summary = agent._generate_comprehensive_summary(
            sample_summary_request, sample_search_results, thinking_phase, visual_insights
        )
    ...
    @patch('src.app.agents.summarizer_agent.get_config')
    def test_extract_key_points(self, mock_get_config, mock_config, sample_summary_request):
    ...
    @patch('src.app.agents.summarizer_agent.get_config')
    def test_calculate_confidence(self, mock_get_config, mock_config, sample_summary_request):
    ...
    @patch('src.app.agents.summarizer_agent.get_config')
    @pytest.mark.asyncio
    async def test_analyze_visual_content_disabled(self, mock_get_config, mock_config, sample_summary_request):
        ...
        insights = await agent._analyze_visual_content(sample_summary_request, thinking_phase)
        
        assert insights == []
    
    @patch('src.app.agents.summarizer_agent.get_config')
    @pytest.mark.asyncio
    async def test_analyze_visual_content_no_elements(self, mock_get_config, mock_config, sample_summary_request):
    ...
    @patch('src.app.agents.summarizer_agent.get_config')
    @pytest.mark.asyncio
    async def test_analyze_visual_content_with_images(self, mock_get_config, mock_config, sample_summary_request):
        ...
        # Mock VLM analysis
        agent.vlm.analyze_visual_content = AsyncMock(return_value={
    ...
    @patch('src.app.agents.summarizer_agent.get_config')
    @pytest.mark.asyncio
    async def test_summarize_comprehensive(self, mock_get_config, mock_config, sample_summary_request):
    ...
    @patch('src.app.agents.summarizer_agent.get_config')
    @pytest.mark.asyncio
    async def test_summarize_brief(self, mock_get_config, mock_config, sample_summary_request):
    ...
    @patch('src.app.agents.summarizer_agent.get_config')
    @pytest.mark.asyncio
    async def test_summarize_bullet_points(self, mock_get_config, mock_config, sample_summary_request):
...
class TestSummarizerAgentEdgeCases:
    ...
    async def test_visual_analysis_failure(self, mock_get_config):
        ...
        agent.vlm.analyze_visual_content = AsyncMock(side_effect=Exception("VLM failed"))
