...
class TestThresholdParameter:
    ...
    def test_threshold_parameter_values(self):
        ...
        assert ThresholdParameter.RELATIONSHIP_CONFIDENCE.value == "relationship_confidence"
...
class TestThresholdConfig:
    ...
    def test_threshold_config_creation(self):
        ...
        assert config.adaptation_strategy == AdaptationStrategy.GRADIENT_BASED  # Default
...
class TestAdaptiveThresholdLearnerIntegration:
    ...
    async def test_multi_parameter_learning(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            samples = [
                {"routing_success": True, "routing_confidence": 0.9, "search_quality": 0.95},
                {"routing_success": False, "routing_confidence": 0.7, "search_quality": 0.6},
                {"routing_success": True, "routing_confidence": 0.8, "search_quality": 0.85},
                {"routing_success": False, "routing_confidence": 0.6, "search_quality": 0.5},
            ]
