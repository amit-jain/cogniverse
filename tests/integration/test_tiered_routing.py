...
class TestTieredEscalation:
    ...
    async def test_relationship_query_escalates(self, router):
        ...
        decision = await router.route("compare the video analysis with the text summary")
    ...
    async def test_structured_extraction_escalation(self, router):
        ...
        assert decision.routing_method in ["gliner", "llm", "llm_parsed", "langextract", "keyword"]
...
class TestSearchModalityDetection:
    ...
    @pytest.mark.parametrize("query,expected_modality", [
...
class TestFullRoutingFlow:
    ...
    async def test_complete_routing_flow(self, router):
        ...
        test_queries = [
            ...
            ("detailed analysis of data", SearchModality.BOTH, GenerationType.DETAILED_REPORT),
        ]
