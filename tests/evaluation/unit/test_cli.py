...
class TestCLI:
    ...
    def mock_task(self):
        ...
        with patch("cogniverse_evaluation.cli.evaluation_task") as mock:
    ...
    def mock_trace_manager(self):
        """Mock TraceManager."""
        with patch("cogniverse_evaluation.cli.TraceManager") as mock_cls:
            manager = Mock()
    ...
    def test_main_entry_point(self):
        ...
        with patch("cogniverse_evaluation.cli.cli") as mock_cli:
