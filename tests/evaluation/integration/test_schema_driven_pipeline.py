...
class TestScorerIntegration:
    ...
    async def test_recall_scorer_with_document_schema(self):
        ...
        state.metadata = {
            ...
            "schema_fields": {"id_fields": ["document_id", "doc_id"]},
        }
        ...
        state.outputs = {
            "config1": {
                "success": True,
                "results": [{"document_id": "DOC001"}, {"document_id": "DOC003"}],
            }
        }
    ...
    async def test_diversity_scorer_with_any_schema(self):
        ...
        state.metadata = {
            ...
            "schema_fields": {"id_fields": ["product_id", "sku"]},
        }
...
class TestEndToEndPipeline:
    ...
    async def test_document_evaluation_pipeline(self):
        ...
        # Verify results
        assert precision.value == pytest.approx(
            1 / 2
        )  # 1 of 2 unique retrieved is relevant
    ...
    async def test_mixed_schema_failure(self):
        ...
        state.outputs = {
            "config1": {"success": True, "results": [{"video_id": "VID001"}]}
        }
