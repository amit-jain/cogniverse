...
class TestChunkProcessor:
    ...
    @patch('json.dump')
    def test_extract_chunks_success(self, mock_json_dump, mock_open, mock_output_manager,
        ...
        with patch.object(processor, '_get_video_duration', return_value=90.0), \
    ...
    @patch('src.common.utils.output_manager.get_output_manager')
    def test_extract_chunks_no_overlap(self, mock_output_manager, no_overlap_processor, 
        ...
        with patch.object(no_overlap_processor, '_get_video_duration', return_value=45.0), \
    ...
    @patch('src.common.utils.output_manager.get_output_manager')
    def test_extract_chunks_with_failed_extraction(self, mock_output_manager, processor, 
                                                  temp_dir, sample_video_path):
        ...
        with patch.object(processor, '_get_video_duration', return_value=90.0), \
             patch.object(processor, '_extract_chunk', side_effect=mock_extract_side_effect), \
             patch('builtins.open', create=True), \
             patch('json.dump'):
    ...
    def test_extract_chunks_legacy_output_dir(self, processor, temp_dir, sample_video_path):
        """Test legacy output directory support."""
        with patch.object(processor, '_get_video_duration', return_value=30.0), \
             patch.object(processor, '_extract_chunk', return_value=True), \
             patch('builtins.open', create=True), \
             patch('json.dump'):
    ...
    def test_chunk_overlap_calculation(self, processor):
        ...
        with patch.object(processor, '_get_video_duration', return_value=80.0), \
             patch.object(processor, '_extract_chunk', return_value=True), \
