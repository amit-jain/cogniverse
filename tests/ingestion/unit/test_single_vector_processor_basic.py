...
class TestSingleVectorVideoProcessor:
    ...
    def test_get_video_info(self, mock_logger):
        ...
        with patch('cv2.VideoCapture') as mock_cv2:
            mock_cap = Mock()
            mock_cap.get.side_effect = [25.0, 1000, 1920, 1080]  # fps, frames, width, height
    ...
    def test_combine_transcripts_overlapping(self, mock_logger):
        ...
        segments = [
            VideoSegment(
                segment_id=0, start_time=0.0, end_time=10.0, frames=[], frame_timestamps=[],
                transcript_segments=[
            ...
            VideoSegment(
                segment_id=1, start_time=8.0, end_time=18.0, frames=[], frame_timestamps=[],
                transcript_segments=[
