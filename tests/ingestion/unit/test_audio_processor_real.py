...
class TestAudioProcessor:
    ...
    def test_processor_initialization(self, mock_logger):
        ...
        processor = AudioProcessor(mock_logger, model="whisper-large-v3", language="es")
    ...
    def test_from_config_factory_method(self, mock_logger):
        ...
        config = {"model": "whisper-medium", "language": "fr"}
    ...
    @patch("whisper.load_model")
    def test_transcribe_audio_with_cache_hit(
