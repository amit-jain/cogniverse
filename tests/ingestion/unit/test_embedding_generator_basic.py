...
class TestEmbeddingGenerator:
    ...
    @patch(
        "cogniverse_core.ingestion.processors.embedding_generator.embedding_generator.EmbeddingProcessor"
    )
    @patch(
        "cogniverse_core.ingestion.processors.embedding_generator.embedding_generator.DocumentBuilderFactory"
    )
    ...
    @patch(
        "cogniverse_core.ingestion.processors.embedding_generator.embedding_generator.get_or_load_model"
    )
    @patch(
        "cogniverse_core.ingestion.processors.embedding_generator.embedding_generator.EmbeddingProcessor"
    )
    ...
    def test_initialization_with_model_load(
        ...
        mock_get_model.assert_called_once_with(
            "custom_model", basic_config, mock_logger
        )
    ...
    def test_should_load_model_conditions(
        ...
        test_cases = ["direct_video_global", "direct_video_local", "video_chunks"]
        ...
        test_cases = ["frame_based", "single_vector", "other_type"]
    ...
    def test_get_video_path_search_video_dir(
        ...
        generator = EmbeddingGenerator(
            config_with_dir, mock_logger, {}, mock_backend_client
        )
