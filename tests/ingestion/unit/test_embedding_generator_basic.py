...
class TestEmbeddingGenerator:
    ...
    def test_should_load_model_conditions(
        ...
        load_cases = [
            ("direct_video_global", "direct_video_segment", "videoprism"),
            ("direct_video_local", "direct_video_segment", "videoprism"),
            ("video_chunks", "video_chunks", "colqwen"),
        ]

        for process_type, embedding_type, model_loader in load_cases:
            profile_config = {
