...
class TestPipelineOrchestration:
    ...
    def test_frame_strategy_processor_requirements(self, mock_logger):
        ...
        frame_strategy = FrameSegmentationStrategy(max_frames=50, extraction_method='histogram')
        strategy_set = ProcessingStrategySet(segmentation=frame_strategy)
        ...
        assert keyframe_config.get("extraction_method") == 'histogram' or keyframe_config.get("fps") is None
    ...
    def test_end_to_end_frame_processing_workflow(self, mock_keyframe_class, mock_logger, 
                                                 strategy_set, temp_dir, sample_video_path):
    ...
    def test_end_to_end_chunk_processing_workflow(self, mock_chunk_class, mock_logger,
                                                 chunk_strategy_set, temp_dir, sample_video_path):
        ...
        with patch('src.app.ingestion.processor_manager.pkgutil.iter_modules') as mock_iter:
            ...
            # Execute processing
            result = chunk_processor.extract_chunks(sample_video_path, video_duration=30.0)
    ...
    def test_processor_error_handling_in_pipeline(self, mock_logger, strategy_set, temp_dir, sample_video_path):
    ...
    def test_processor_cache_consistency_across_pipeline(self, mock_logger, strategy_set):
