...
class TestTenantAwareSearchClientInitialization:
    ...
    @patch("cogniverse_vespa.tenant_aware_search_client.TenantSchemaManager")
    @patch("cogniverse_vespa.tenant_aware_search_client.VespaVideoSearchClient")
    def test_initialization_with_required_params(self, mock_client_class, mock_manager_class):
        ...
        client = TenantAwareVespaSearchClient(
            tenant_id="acme", base_schema_name="video_colpali", config_manager=MagicMock(), schema_loader=MagicMock()
        )
    ...
    @patch("cogniverse_vespa.tenant_aware_search_client.TenantSchemaManager")
    def test_initialization_requires_tenant_id(self, mock_manager_class):
        """Test that tenant_id is required"""
        with pytest.raises(ValueError, match="tenant_id is required"):
            TenantAwareVespaSearchClient(tenant_id="", base_schema_name="video_colpali", config_manager=MagicMock(), schema_loader=MagicMock())

    @patch("cogniverse_vespa.tenant_aware_search_client.TenantSchemaManager")
    def test_initialization_requires_base_schema_name(self, mock_manager_class):
        """Test that base_schema_name is required"""
        with pytest.raises(ValueError, match="base_schema_name is required"):
            TenantAwareVespaSearchClient(tenant_id="acme", base_schema_name="", config_manager=MagicMock(), schema_loader=MagicMock())

    @patch("cogniverse_vespa.tenant_aware_search_client.TenantSchemaManager")
    @patch("cogniverse_vespa.tenant_aware_search_client.VespaVideoSearchClient")
    def test_schema_name_resolution(self, mock_client_class, mock_manager_class):
        ...
        client = TenantAwareVespaSearchClient(
            tenant_id="acme", base_schema_name="video_colpali_smol500_mv_frame", config_manager=MagicMock(), schema_loader=MagicMock()
        )
    ...
    @patch("cogniverse_vespa.tenant_aware_search_client.TenantSchemaManager")
    @patch("cogniverse_vespa.tenant_aware_search_client.VespaVideoSearchClient")
    def test_auto_create_schema_enabled(self, mock_client_class, mock_manager_class):
        ...
        _client = TenantAwareVespaSearchClient(
            tenant_id="acme", base_schema_name="video_colpali", config_manager=MagicMock(), schema_loader=MagicMock(), auto_create_schema=True
        )
    ...
    @patch("cogniverse_vespa.tenant_aware_search_client.TenantSchemaManager")
    @patch("cogniverse_vespa.tenant_aware_search_client.VespaVideoSearchClient")
    def test_auto_create_schema_disabled(self, mock_client_class, mock_manager_class):
        ...
        _client = TenantAwareVespaSearchClient(
            tenant_id="acme", base_schema_name="video_colpali", config_manager=MagicMock(), schema_loader=MagicMock(), auto_create_schema=False
        )
...
class TestTenantAwareSearchClientSearchMethods:
    ...
    @patch("cogniverse_vespa.tenant_aware_search_client.TenantSchemaManager")
    @patch("cogniverse_vespa.tenant_aware_search_client.VespaVideoSearchClient")
    def test_search_delegates_with_tenant_schema(self, mock_client_class, mock_manager_class):
    ...
    @patch("cogniverse_vespa.tenant_aware_search_client.TenantSchemaManager")
    @patch("cogniverse_vespa.tenant_aware_search_client.VespaVideoSearchClient")
    def test_search_with_embeddings(self, mock_client_class, mock_manager_class):
...
class TestTenantAwareSearchClientUtilityMethods:
    ...
    @patch("cogniverse_vespa.tenant_aware_search_client.TenantSchemaManager")
    @patch("cogniverse_vespa.tenant_aware_search_client.VespaVideoSearchClient")
    def test_health_check(self, mock_client_class, mock_manager_class):
    ...
    @patch("cogniverse_vespa.tenant_aware_search_client.TenantSchemaManager")
    @patch("cogniverse_vespa.tenant_aware_search_client.VespaVideoSearchClient")
    def test_get_tenant_info(self, mock_client_class, mock_manager_class):
        ...
        client = TenantAwareVespaSearchClient(
            tenant_id="acme", base_schema_name="video_colpali", config_manager=MagicMock(), schema_loader=MagicMock(), backend_port=8080
        )
    ...
    @patch("cogniverse_vespa.tenant_aware_search_client.TenantSchemaManager")
    @patch("cogniverse_vespa.tenant_aware_search_client.VespaVideoSearchClient")
    def test_get_available_strategies(self, mock_client_class, mock_manager_class):
    ...
    @patch("cogniverse_vespa.tenant_aware_search_client.TenantSchemaManager")
    @patch("cogniverse_vespa.tenant_aware_search_client.VespaVideoSearchClient")
    def test_repr(self, mock_client_class, mock_manager_class):
...
class TestTenantAwareSearchClientMultipleTenants:
    ...
    def test_different_tenants_get_different_schemas(
        ...
        client_b = TenantAwareVespaSearchClient(
            tenant_id="startup", base_schema_name="video_colpali", config_manager=MagicMock(), schema_loader=MagicMock()
        )
