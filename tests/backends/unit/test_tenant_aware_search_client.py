...
class TestTenantAwareSearchClientInitialization:
    ...
    @patch("cogniverse_vespa.vespa.tenant_aware_search_client.get_tenant_schema_manager")
    @patch("cogniverse_vespa.vespa.tenant_aware_search_client.VespaVideoSearchClient")
