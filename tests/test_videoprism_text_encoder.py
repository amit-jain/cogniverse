...
class TestVideoPrismTextEncoder(unittest.TestCase):
    ...
    def test_encoder_initialization(self):
        ...
        encoder = VideoPrismTextEncoder(model_name="test_model", embedding_dim=768)
    ...
    def test_encode_basic(self):
        ...
        self.vp_mock.models.tokenize_texts.assert_called_with(
            encoder.tokenizer, ["a video of test query."]
        )
    ...
    def test_encode_with_error(self):
        ...
        # Make tokenize fail
        self.vp_mock.models.tokenize_texts.side_effect = Exception(
            "Tokenization failed"
        )
    ...
    def test_factory_function(self):
        ...
        encoder = create_text_encoder(
            model_name="test_model", embedding_dim=768, cache_size=500
        )
