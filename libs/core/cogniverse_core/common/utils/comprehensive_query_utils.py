...
def build_query_params(
    ...
    query_params = {"ranking": ranking_profile, "hits": hits}
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                results[strategy] = {
                    ...
                    "sample_scores": [
                        hit.get("relevance", 0) for hit in hits_returned[:3]
                    ],
                }
...
def print_benchmark_results(results: Dict[str, Any]):
    ...
    if successful:
        ...
        for i, strategy in enumerate(sorted_by_speed, 1):
            ...
            print(f"   {i}. {strategy}")
            print(
                f"      Time: {time_ms}ms | Hits: {hits} | Avg Score: {avg_score:.3f}"
            )
...
if __name__ == "__main__":
    ...
    results = benchmark_all_strategies(query_text="fire", num_tokens=2, hits=5)
