...
class AudioProcessor(BaseProcessor):
    ...
    def __init__(self, logger: logging.Logger, model: str = "whisper-large-v3", 
                 language: str = "auto"):
        """
    ...
    @classmethod
    def from_config(cls, config: Dict[str, Any], logger: logging.Logger) -> 'AudioProcessor':
    ...
    def transcribe_audio(self, video_path: Path, output_dir: Path = None, cache=None) -> Dict[str, Any]:
        ...
        if output_dir is None:
            ...
            transcript_file = output_manager.get_processing_dir("transcripts") / f"{video_id}_transcript.json"
        else:
            # Legacy path support
        ...
        try:
            ...
            self.logger.info(f"   ✅ Audio transcribed in {transcription_time:.2f}s ({len(segments)} segments)")
