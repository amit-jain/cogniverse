...
class EmbeddingProcessor(BaseProcessor):
    ...
    def __init__(self, logger: logging.Logger, embedding_type: str = "multi_vector",
    ...
    @classmethod
    def from_config(cls, config: Dict[str, Any], logger: logging.Logger) -> 'EmbeddingProcessor':
