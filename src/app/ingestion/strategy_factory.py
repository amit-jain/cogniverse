...
class StrategyFactory:
    ...
    @classmethod
    def create_from_profile_config(cls, profile_config: Dict[str, Any]) -> ProcessingStrategySet:
        """
    ...
    @classmethod
    def _create_strategy_instance(cls, class_name: str, params: Dict[str, Any]) -> BaseStrategy:
        """
