...
class VideoIngestionPipelineBuilder:
    ...
    def with_app_config(self, app_config: Dict[str, Any]) -> 'VideoIngestionPipelineBuilder':
    ...
    def build(self) -> VideoIngestionPipeline:
        ...
        if not self._config:
            ...
            self._config = PipelineConfig(**config_dict) if config_dict else PipelineConfig.from_config()
