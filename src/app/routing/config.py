...
class RoutingConfig:
    ...
    tier_config: Dict[str, Any] = field(default_factory=lambda: {
    ...
    gliner_config: Dict[str, Any] = field(default_factory=lambda: {
        ...
        "labels": [
            ...
            "purchase_intent", "comparison_intent", "query_intent", "complaint_intent"
        ],
...
Use exact JSON format in your response."""
    ...
    langextract_config: Dict[str, Any] = field(default_factory=lambda: {
        "enabled": False,
