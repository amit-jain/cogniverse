...
class RoutingDecision:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "needs_video_search": self.search_modality in [SearchModality.VIDEO, SearchModality.BOTH],
            "needs_text_search": self.search_modality in [SearchModality.TEXT, SearchModality.BOTH]
        }
...
class RoutingStrategy(ABC):
    ...
    def record_metrics(self, query: str, decision: RoutingDecision, 
