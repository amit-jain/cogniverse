...
class Document:
    ...
    def add_embedding(self, name: str, embedding: Union[List, Dict, Any], metadata: Optional[Dict] = None):
    ...
    def set_processing_status(self, status: ProcessingStatus, error_message: Optional[str] = None):
    ...
    def __str__(self) -> str:
        ...
        return f"Document(id={self.id[:8]}, type={self.content_type.value}, content_id={self.content_id})"
    
    def __repr__(self) -> str:
        """Detailed representation."""
        return f"Document(id='{self.id}', type={self.content_type.value}, status={self.status.value})"