...
class VideoPlayerTool(BaseTool):
        ...
        for result in results_list:
            if isinstance(result, dict):
                ...
                if timestamp is not None:
                    ...
                    description = result.get("description", result.get("content", "Search result"))
    ...
    def _generate_simple_video_player_html(
        ...
        start_info = f"<p><strong>Start Time:</strong> {start_time}s</p>" if start_time else ""
