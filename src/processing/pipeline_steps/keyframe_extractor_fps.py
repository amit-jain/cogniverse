...
class FPSKeyframeExtractor:
    ...
    def extract_keyframes(self, video_path: Path, output_dir: Path = None) -> Dict[str, Any]:
        ...
        print(f"📸 Extracting keyframes at {self.target_fps} FPS from: {video_path.name}")
        ...
        print(f"  📊 Video FPS: {video_fps:.1f}, Target FPS: {self.target_fps}, Frame interval: {frame_interval}")
        return metadata