...
async def run_document_search_evaluation():
    ...
    test_queries = [
        ...
        {
            "query": "python",
            "expected_docs": ["doc005"]  # Python programming guide
        },
        {
            "query": "vision",
            "expected_docs": ["doc004"]  # Computer vision
        }
    ]
    ...
    for test_case in test_queries:
        ...
        logger.info(f"Ground truth extraction:")
...
async def run_image_search_evaluation():
    ...
    class MockImageBackend:
        ...
        def __init__(self):
            ...
            self.images = [
                {"image_id": "img001", "description": "sunset over mountains", "tags": ["nature", "sunset"]},
                {"image_id": "img002", "description": "cat playing with yarn", "tags": ["animal", "cat"]},
                {"image_id": "img003", "description": "city skyline at night", "tags": ["urban", "night"]},
            ]
    ...
    for result in results:
        ...
        logger.info(f"  - {image_id}: {result.get('description')} (score: {result.get('score'):.2f})")
