...
def calculate_precision_at_k(results: List[str], expected: List[str], k: int = 5) -> float:
    """
...
def calculate_map(results_list: List[List[str]], expected_list: List[List[str]]) -> float:
    """
